...
@endphp
        <div x-data="buku" x-init="buku('{{$token}}')" class="w-full flex flex-wrap overflow-y-scroll pb-6 max-h-[525px]">
        ...
        <div class="overflow-x-auto relative shadow-md sm:rounded-lg">
          <table class="w-full text-center text-[10px]">
              ...
              <tbody class="text-[12px]">
                  <template x-for="buk, i in data">
                        <tr class="bg-white border-b">
                            <th x-text="i + 1" scope="row" class="py-5 px-6 font-medium text-gray-900 whitespace-nowrap"></th>
                            <td x-text="buk.isbn" class="py-5 px-6"></td>
                            <td class="py-5 px-6" x-text="buk.judul"></td>
                            <td class="py-5 px-6 text-center" x-text="buk.penerbit"></td>
                            <td class="py-5 px-6 text-center" x-text="buk.tahun_terbit"></td>
                            <td class="py-5 px-6 text-center" x-text="buk.kuota"></td>
                            {{-- <td class="py-5 px-6">
                            ...
                            <td class="py-5 px-6">
                                <div class="flex justify-center gap-2">
                                    ...
                                    <button @click="deleteBuku('{{$token}}', buk.id)"><svg class="w-4 h-4" fill="none" stroke="red" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path></svg></button>
